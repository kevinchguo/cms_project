...
creatureRouter.route("/land").get((req, res) => {
  return req.db.Creature.forge()
    .where({ category_id: 1 })
    .fetchAll({
      withRelated: [
...
creatureRouter.route("/water").get((req, res) => {
  return req.db.Creature.forge()
    .where({ category_id: 2 })
    .fetchAll({
      withRelated: [
...
creatureRouter.route("/sky").get((req, res) => {
  return req.db.Creature.forge()
    .where({ category_id: 3 })
    .fetchAll({
      withRelated: [
...
creatureRouter.route("/mythical").get((req, res) => {
  return req.db.Creature.forge()
    .where({ category_id: 4 })
    .fetchAll({
      withRelated: [
...
creatureRouter.route("/newborn").get((req, res) => {
  return req.db.Creature.forge()
...
creatureRouter.route("/young").get((req, res) => {
  return req.db.Creature.forge()
...
creatureRouter.route("/adult").get((req, res) => {
  return req.db.Creature.forge()
...
creatureRouter.route("/elder").get((req, res) => {
  return req.db.Creature.forge()
...
creatureRouter.route("/deceased").get((req, res) => {
  return req.db.Creature.forge()
